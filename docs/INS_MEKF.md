...
GNSS SOG and COG form North/East velocity measurements. Their configured base
noise is multiplied by `1`, `2`, `4`, or `6` for RTK Fixed, RTK Float, DGNSS,
or GPS respectively.

### Heading

Fresh valid dual-antenna heading is the primary yaw aid. If it expires and
...
- The local flat-earth frame omits Earth rotation, Coriolis, and transport-rate
  terms. It is intended for short-duration, local USV missions.
